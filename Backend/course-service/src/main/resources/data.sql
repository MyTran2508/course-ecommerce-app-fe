INSERT IGNORE INTO `level`(id, created, creator, modifier, removed, updated, description, `name`)
...
INSERT IGNORE INTO `topic`(id, created, creator, modifier, removed, updated, description, `name`, category_id)

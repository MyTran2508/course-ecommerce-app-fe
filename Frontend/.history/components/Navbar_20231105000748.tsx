      ...
      {isOpenCategory && (
        ...
        >
          <ul className="dropdown-list">
            <Item itemName="Backend" hasIcon={true} />
            <Item itemName="Frontend" hasIcon={true} />
            <Item itemName="Testing" hasIcon={true} />
            <Item itemName="Mobile" hasIcon={true} />
          </ul>
          {isOpenTopics && (
            <ul className="dropdown-list">
...
const Item = ({ itemName, hasIcon }: any) => {
  return (
    <li className="dropdown-item">
      <span>{itemName}</span>

...
const Category = () => {
  ...
  return (
    <div className="dropdown ml-6">
      <button
        className="dropdown__select text-lg"
      ...
      {isOpenCategory && (
        <ul
          ...
          onMouseLeave={() => setOpenCategory(false)}
        >
          <CategoryItem categoryName="Backend" />
          <CategoryItem categoryName="Frontend" />
          <CategoryItem categoryName="Testing" />
        </ul>
      )}
    </div>
  );
...
const CategoryItem = ({ categoryName }: any) => {
  return (
    <li className="dropdown__options__item">
...
const Topics = ({ topicName }: any) => {
  return (
    <li className="topic__options__item">
      <span>{topicName}</span>
      <AiOutlineRight />
      <ul></ul>
    </li>
